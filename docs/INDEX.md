...
| **How the integration is accepted, once the UI exists** | `labos-airtable/testing/five-workflow-e2e-acceptance-2026-09-11.md` — eleven scenarios across all five workflows, Testing only, **AUTOMATED BACKEND ASSERTION separated from HUMAN/UI ACCEPTANCE STEP**. Backend half green at 60/60 | `ifet-management` `tests/e2e_acceptance.py` (the harness) · `labos-airtable/testing/baseline-2026-09-11/` (the run) |
| **What the UI developer builds, and how it is signed off** | `labos-airtable/contract/tc5-ui-developer-handoff-2026-09-11.md` — five screens, route-by-route, verified against the running app | `ifet-management/openapi.json` (generated, gated) · `ifet-management/MANUAL_TESTS_API.md` · `labos-airtable/testing/five-workflow-e2e-acceptance-2026-09-11.md` |
...
| **What the Airtable team must create in production** — **the canonical external contract** | `labos-airtable/correspondence/LabOS-Airtable-Production-Schema-Requirements-2026-09-11.md` + its generated companion `LabOS-Airtable-Production-Schema-Changes-2026-09-11.csv` (19 ADD, 142 → 161). **One document, one CSV; nothing else restates the field list** | `labos-airtable/runbooks/production-airtable-promotion-2026-09-11.md` — *internal* execution notes only · `evidence/testing-base-changes-2026-09-06/production-change-spec.csv` — the same generated sheet, kept beside the change it documents |
